...
class DqnAgent:
    def __init__(self,
        ...
        self.policy_net = SimpleDQN(observation_shape[0],
                                    number_of_actions).to(self.device)
        self.target_net = SimpleDQN(observation_shape[0],
                                    number_of_actions).to(self.device)
...
def make_dqn_agent(params, observation_shape, number_of_actions, seed):

    agent = DqnAgent(observation_shape=observation_shape,
